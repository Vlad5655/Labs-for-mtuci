public class Main {
    public static void main(String[] args) {
        ...
        fleet.addCar("A111AA77", new Car("Toyota", "Camry", 2020));
        fleet.addCar("B222BB77", new Car("BMW", "X5", 2021));
        fleet.addCar("C333CC77", new Car("Lada", "Vesta", 2023));

        System.out.println("Все автомобили в автопарке:");
        fleet.printAllCars();

        System.out.println("\nПоиск автомобиля B222BB77:");
        System.out.println(fleet.findCar("B222BB77"));

        System.out.println("\nУдаление автомобиля A111AA77:");
        System.out.println(fleet.removeCar("A111AA77"));
